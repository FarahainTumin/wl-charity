...
<div class="heightForQrBg page-header align-items-start" style="display:block; padding-right: 20px; padding-left: 20px; background-image: url('../images/fulls/bantuan_turki_syria.png');">
