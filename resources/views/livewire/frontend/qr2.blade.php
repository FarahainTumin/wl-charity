...
<header id="header" style="background-color: #e7e7e7">
    <div class="row" style="margin: 0px;">
        ...
        <div class="col-sm-8" style="text-align: justify;padding-top: 10px;padding-left: 0px; font-family: Cambria;">
            ...
            <h6 class="fontSizeHeader" style="margin: 0px; padding: 0px; line-height: 50px;">P103 : <br><div>Zakat Fitrah</div></h6>
            <?php
...
<div class="heightForQrBg page-header align-items-start" style="background-image: url('http://wl-charity.test:8081/images/fulls/Zakat_Fitrah.jpg');">
