...
<body class="g-sidenav-show bg-white" style="width: 720px; height: 1280px; margin: 0 auto;" onclick="window.location='/welcome';">
...
{{--        <a class="btn btn-icon btn-lg btn-3" style="position: absolute; right: 30px; bottom: 70px;" href="http://wl-charity.test:8081/">--}}
{{--            <i class="fas fa-arrow-right" style="font-size: xxx-large; color: black"></i>--}}
{{--        </a>--}}
        <div class="fix">
